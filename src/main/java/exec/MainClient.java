...
//        }
        ...
        Book book1 = new Book("book1", "author1", "editorial1", "isbn1"); // crea un libro
        try {
            user1=(User)ClienteDAO.create(user1);
            book1=(Book)ClienteDAO.create(book1);
            Loan loan1 = new Loan(new java.sql.Date(System.currentTimeMillis()), null, "test",book1,user1); // crea un prestamo
            ClienteDAO.create(loan1); //crea el prestamo
        } catch (Exception e) {
            System.err.println(e.getMessage());
        }
